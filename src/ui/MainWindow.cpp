...
QString manualText() {
    return QStringLiteral(
        ...
        "line, and prevents ordinary edits. Select text and press "
        "**Ctrl+Shift+H** to add or remove a saved `==highlight==`. The plain "
        "**↑** and **↓** keys scroll the page; links, search, folding and "
        "selection/copy keep working. Read Mode is remembered separately for "
        "each vault.\n"
        "\n"
        "## Getting around\n"
